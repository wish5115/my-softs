...
(() => {
    ...
    // 'barPlugins', 'barCommand', 'barSearch', 
    const rightToolBarExcludes = ['barMode'];
    ...
    function set_css_style() {
        ...
        styleElement.textContent = `
            ...
            .layout__center [data-type="wnd"] > .fn__flex:first-child.fn__none + .layout-tab-container {
                height: calc(100% - ${tabHeight-0}px);
                margin-top: ${tabHeight-0}x;
            }
            #dockLeft {
