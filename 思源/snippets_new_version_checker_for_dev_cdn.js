...
(() => {
    const urls = ['cdn.jsdmirror.cn','jsd.onmicrosoft.cn','gcore.jsdelivr.net','fastly.jsdelivr.net','quantil.jsdelivr.net','originfastly.jsdelivr.net','cdn.jsdmirror.com','cdn.mengze.vip','update.gf.qytechs.cn','jsd.nmmsl.top','cdn.bili33.top','jsdelivr.qaq.qa','gitee.com','raw.githubusercontent.com'];
